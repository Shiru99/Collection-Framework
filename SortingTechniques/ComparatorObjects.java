...
public class ComparatorObjects {
    public static void main(String[] args) {
        ...
        // Collections.sort(students,(This,That)-> This.name.compareTo(That.name)); //
        // sort by name
        ...
        Collections.sort(students,
                Comparator.comparing(StudentClass::getName).reversed().thenComparing(StudentClass::getMarks));
        students.forEach(System.out::println);
        /*
         * Student [name = Tom marks = 36]
         * Student [name = John marks = 35]
